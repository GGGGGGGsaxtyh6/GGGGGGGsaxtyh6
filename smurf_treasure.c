...
int validate_stage3(const char* input) {
    ...
    // Flag ofuscada: HTB{smurf_w4s_h3r3_and_s0_w4s_y0ur_fl4g}
    unsigned char obfuscated_flag[] = {
        0x48^0x42, 0x54^0x42, 0x42^0x42, 0x7b^0x42, 0x73^0x42, 0x6d^0x42, 0x75^0x42, 0x72^0x42, 0x66^0x42, 0x5f^0x42,
        0x77^0x42, 0x34^0x42, 0x73^0x42, 0x5f^0x42, 0x68^0x42, 0x33^0x42, 0x72^0x42, 0x33^0x42, 0x5f^0x42, 0x61^0x42,
        0x6e^0x42, 0x64^0x42, 0x5f^0x42, 0x73^0x42, 0x30^0x42, 0x5f^0x42, 0x77^0x42, 0x34^0x42, 0x73^0x42, 0x5f^0x42,
        0x79^0x42, 0x30^0x42, 0x75^0x42, 0x72^0x42, 0x5f^0x42, 0x66^0x42, 0x6c^0x42, 0x34^0x42, 0x67^0x42, 0x7d^0x42, 0x00
    };
    
    // Deofuscar la flag
    char expected[42];
    for (int i = 0; i < 41; i++) {
        expected[i] = obfuscated_flag[i] ^ 0x42;
    }
    expected[41] = '\0';
