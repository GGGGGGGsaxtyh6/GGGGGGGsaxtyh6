...
echo "🔥 Construyendo ULTIMATE INSANE VAULT - Challenge EXTREME de reverse engineering..."
...
gcc -o ultimate_insane_vault ultimate_insane_vault.c \
    -O3 \
    -s \
    -fno-stack-protector \
    -fno-pie \
...
additional_strings = [
    "Ultimate Insane Vault Access System",
...
cat confusing_strings.txt >> ultimate_insane_vault
cat additional_strings.txt >> ultimate_insane_vault
...
cat > ultimate_insane_hints.txt << 'EOF'
# PISTAS PARA ULTIMATE INSANE VAULT
# ==================================

## Pista 1: Análisis de la Máquina Virtual Metamórfica
- El binario implementa una máquina virtual metamórfica
- Usa 'objdump -d ultimate_insane_vault' para ver el assembly
...
cat > ultimate_insane_fake_flags.txt << 'EOF'
...
cat > ultimate_insane_analyze.sh << 'EOF'
#!/bin/bash
...
chmod +x ultimate_insane_analyze.sh

echo "✅ Archivos auxiliares creados"
echo ""

# Mostrar información final
echo "🎯 Ultimate Insane Vault construido exitosamente!"
echo ""
echo "📁 Archivos creados:"
echo "  - ultimate_insane_vault (binario principal)"
echo "  - ultimate_insane_hints.txt (pistas para resolver)"
echo "  - ultimate_insane_fake_flags.txt (flags falsas)"
echo "  - ultimate_insane_analyze.sh (script de análisis)"
echo ""
echo "📊 Información del binario:"
file ultimate_insane_vault
echo "Tamaño: $(ls -lh ultimate_insane_vault | awk '{print $5}')"
echo ""
echo "🔍 Strings HTB encontrados:"
strings ultimate_insane_vault | grep -E "HTB\{.*\}" | head -10
echo ""
echo "⚠️  Nota: La flag real está cifrada en la máquina virtual metamórfica"
echo ""
echo "🎯 Para resolver este challenge:"
echo "1. Lee ultimate_insane_hints.txt para pistas"
echo "2. Usa ultimate_insane_analyze.sh para análisis inicial"
